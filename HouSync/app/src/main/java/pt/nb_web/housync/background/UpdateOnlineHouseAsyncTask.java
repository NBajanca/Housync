 ...
 */
public class UpdateOnlineHouseAsyncTask extends AsyncTask<Pair<Integer, String>, Void, Void> {
    private final Context context;
    private static MyApi myApiService = null;
    private HouseService houseService;

    public UpdateOnlineHouseAsyncTask(Context context) {
        this.context = context;
        houseService = HouseService.getInstance(context);
    }

    @Override
    protected Void doInBackground(Pair<Integer, String>... params) {
        ...
        try {
            House houseToUpdate = houseService.getOnlineHouse(houseId);
            Pair houseAndFieldToUpdate = new Pair(houseToUpdate, fieldToUpdate);
