...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "addUserToHouse".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link AddUserToHouse#execute()} method to invoke the remote operation.
   *
   * @param houseId
   * @param userId
   * @return the request
   */
  public AddUserToHouse addUserToHouse(java.lang.Integer houseId, java.lang.Integer userId) throws java.io.IOException {
    AddUserToHouse result = new AddUserToHouse(houseId, userId);
    initialize(result);
    return result;
  }

  public class AddUserToHouse extends MyApiRequest<com.example.nuno.myapplication.housync_backend.myApi.model.HouSyncHouse> {

    private static final String REST_PATH = "addUserToHouse/{houseId}/{user_id}";
     ...
     * parameters, call the {@link AddUserToHouse#execute()} method to invoke the remote operation.
     * <p> {@link AddUserToHouse#initialize(com.google.api.client.googleapis.services.AbstractGoogleCl
     ...
     * @since 1.13
     */
    protected AddUserToHouse(java.lang.Integer houseId, java.lang.Integer userId) {
    ...
    @Override
    public AddUserToHouse setAlt(java.lang.String alt) {
      return (AddUserToHouse) super.setAlt(alt);
    }

    @Override
    public AddUserToHouse setFields(java.lang.String fields) {
      return (AddUserToHouse) super.setFields(fields);
    }

    @Override
    public AddUserToHouse setKey(java.lang.String key) {
      return (AddUserToHouse) super.setKey(key);
    }

    @Override
    public AddUserToHouse setOauthToken(java.lang.String oauthToken) {
      return (AddUserToHouse) super.setOauthToken(oauthToken);
    }

    @Override
    public AddUserToHouse setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (AddUserToHouse) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public AddUserToHouse setQuotaUser(java.lang.String quotaUser) {
      return (AddUserToHouse) super.setQuotaUser(quotaUser);
    }

    @Override
    public AddUserToHouse setUserIp(java.lang.String userIp) {
      return (AddUserToHouse) super.setUserIp(userIp);
    }
    ...
    public AddUserToHouse setHouseId(java.lang.Integer houseId) {
    ...
    public AddUserToHouse setUserId(java.lang.Integer userId) {
      this.userId = userId;
      return this;
    }

    @Override
    public AddUserToHouse set(String parameterName, Object value) {
      return (AddUserToHouse) super.set(parameterName, value);
    }
  }
